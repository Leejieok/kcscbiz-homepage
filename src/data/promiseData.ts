  ...
  promises: [
    {
      ...
      description: '많은 컨설팅 회사들은 연체, 체납이 있더라도 당장의 수익을 위해, 계약을 체결하곤 합니다. 한국중소기업 비즈니스센터는 대표님들의 시간과 신뢰를 중요시 여기며, ',
    ...
    },
    {
      number: '약속 2',
      title: '소통 실력은 ',
      titleHighlight: ['한비즈가 최고입니다.'],
      description: '한국중소기업 비즈니스센터는 전문 컨설턴트를 20명 이상 고용하고 있습니다. ',
    ...
    },
    {
      ...
      description: '',
      descriptionHighlight: '한비즈는 3,000건 이상 성공 사례를 보유하고 있습니다. 모든 기업들이 원하는 결과를 빨리 실현할 수 있도록 맞춤 컨설팅 플랜으로 최고의 결과를 선물하겠습니다.',
