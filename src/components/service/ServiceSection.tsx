...
function ServiceSection() {
  ...
  return (
    <section
      className="w-full px-4 py-28 relative flex items-center"
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <header className="space-y-6">
              ...
              <div className="space-y-2 animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
                ...
                <h3 className="text-6xl font-bold text-blue-700 tracking-tight">
                  업종별 지원 가능한
                </h3>
                <h3 className="text-6xl font-bold text-blue-700 tracking-tight">
                  정책자금 한도,
              ...
              <div className="animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
                <p className="text-2xl leading-loose" style={{ color: '#544d4d' }}>
                  간이과세도 <strong>최대 1억 원</strong>까지 지원 대상!
                </p>
              </div>
              ...
              <div className="animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
                <a
                  ...
                  className="inline-block px-6 py-3 border-2 border-blue-500 text-blue-500 hover:text-white font-medium hover:bg-blue-700 hover:border-blue-700 transition-colors rounded-full"
