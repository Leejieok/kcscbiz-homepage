    ...
    <section className="w-full py-8 sm:py-10 md:py-12 lg:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-2 sm:px-4">
        ...
        <div className="mb-6 sm:mb-8 md:mb-10 lg:mb-12 animate-fadeInUp">
          <div className="space-y-0.5 sm:space-y-1 leading-relaxed">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#544d4d] font-bold">
              {beforeAfterData.description[0]}
            </p>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#544d4d] font-bold">
              {beforeAfterData.description[1]}
            </p>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-orange-500 font-bold">
              {beforeAfterData.description[2]}
            </p>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-[#544d4d]">
